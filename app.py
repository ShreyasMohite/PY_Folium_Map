                ...
                if lng.get()!="":
                    if size.get()!="Select Size":
                        if save.get()!="":
                            ...
                            map3 = folium.Map(location=[lat.get(), lng.get()], zoom_start=size.get())
                            map3.create_map(path='{}.html'.format(save.get()))
...
#=================================firstframe===============================================#
        ...
        self.original9 = Image.open("google.jpg")
